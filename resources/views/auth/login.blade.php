...
<div class="container" id="login">
    <div class="row">
        <div class="col-lg-8 offset-lg-2 spacer">
            <div class="card add-padding">
                <div class="card-content">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mb-0 extra-spacing">
                    ...
                    <p align="center">Don't have an account? <a href="/register">Create one here.</a></p>
                </div>
            </div>
        </div>
